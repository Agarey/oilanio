          ...
          <div className={styles.desktopHeader_mobile}>
            <div className={styles.logo_mobile}>
              <Link href={'/'}>
                ...
                >
                  <svg className={styles.svgLogo} width="150" height="48" viewBox="0 0 150 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <Image className={styles.pngLogo} src={'https://realibi.kz/file/474414.png'}/>
                </a>
              </Link>
            </div>
