...
import CourseHelpWithFullPage from "../src/components/CourseHelpWithFullPage/CourseHelpWithFullPage";
...
const CreateApplication = (props) => {
  ...
  function loadCategories(searchCenter) {
    ...
    axios
      .post(`${globals.productionServerDomain}/getFilteredCategories`, {
  ...
  return (
    ...
    >
      <div className={styles.displayNoneOnMobile}>
        <Image
          src={"https://realibi.kz/file/902932.png"}
          style={{
            position: "absolute",
            top: "5%",
            left: "5%",
      ...
      <div className={styles.container}>
          ...
          <div className={styles.mainLeft}>
            <div className={styles.titleBlock}>
              <span className={styles.title}>
                Нужно найти репетитора или образовательный центр?
              </span>
            </div>

            <span className={styles.subtitleBottom} style={{ fontSize: 30 }}>
        ...
        <div className={styles.obenGide}>
          <button
            ...
            onClick={() => {
              setShowGide(!showGide);
              setTimeout(function () {
                window.scrollTo({ behavior: "smooth", top: 1300, bottom: 0 });
              }, 1000);
      ...
      <Image
        ...
        style={{ width: "5%" }}
        src={"https://realibi.kz/file/469063.png"}
      />
      <div
      ...
      >
        ...
        <div className={styles.downRowsLeft}>
          <Image
            src={"https://realibi.kz/file/811213.jpg"}
            className={styles.downImg}
          />
          <div className={styles.rowTextLeft}>
            <span className={styles.downRowTitle}>Начало</span>
            <p className={styles.downRowText}>
              Чтобы подать заявку центрам&#47;репетиторам, нажмите на кнопку{" "}
              <b>"Создать заявку"</b>
            </p>
          </div>
        </div>
        <div className={styles.downRowsRight}>
          <div className={styles.rowTextRight}>
            ...
            <p className={styles.downRowText}>
              Заполните все необходимые для обучения поля, и нажмите на кнопку{" "}
              <b>"Создать заявку"</b>
            </p>
          </div>
          <Image
            src={"https://realibi.kz/file/374313.jpg"}
            className={styles.downImg}
          />
        </div>
        <div className={styles.downRowsLeft}>
          <Image
            src={"https://realibi.kz/file/847800.jpg"}
            className={styles.downImg}
          />
          <div className={styles.rowTextLeft}>
            <span className={styles.downRowTitle}>Обучение</span>
            <p className={styles.downRowText}>
              В ближайшее время, наши партнеры свяжутся с вами. Вам лишь нужно
              будет выбрать самого подходящего для вас и начать обучение
            </p>
          </div>
        </div>
        <div className={styles.downRowsRight}>
          <div className={styles.rowTextRight}>
            ...
            <p className={styles.downRowText}>
              Если что-то пошло не так, вы всегда можете сами найти себе курс на
              странице{" "}
              <a
          ...
          <Image
            src={"https://realibi.kz/file/224362.jpg"}
            className={styles.downImg}
          />
        </div>
        <button
          className={classnames(styles.downButton, styles.hideButton)}
          onClick={() => {
            setShowGide(false);
            setSearchCenter(false);
            window.scrollBy(0, -10000);
