...
import styles from "./AdministrateCourses.module.css";
import globals from "../../globals";

const axios = require("axios").default;

const AdministrateCourses = () => {
...

                                {
                                    loading ?
                                        <span className={styles.loadingMessage}>
                                            Обработка данных...
                                            <img src="/loader.gif" alt="loading.png" className={styles.loadingImage}/>
                                       </span>
                                        : null
                                }
...
export default AdministrateCourses
