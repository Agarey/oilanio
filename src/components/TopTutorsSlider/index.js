          ...
          categories.map((category, idx)=>{
            ...
            return (
              category.img_src !== "https://realibi.kz/file/338803.png" 
                ? (
                  <a onClick={async () => {{findedTutor?.category_name ? setShow(!show) : ''} 
                  console.log("findTutorId", findedTutor)}} key={idx} className={styles.category}>
                    ...
                    <label className={styles.labels} > <svg width="19" height="25" viewBox="0 0 19 25" fill="none" xmlns="http://www.w3.org/2000/svg">
