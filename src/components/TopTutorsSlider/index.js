...
const TopTutorsSlider2 = (props) => {
  ...
  const [tutorCourseCards, setTutorCourseCards] = useState([]);
      ...
      >
        {
          categories.map((category, idx)=>{
            ...
            useEffect( () => {
              const findTutorId = tutorCourseCards.find(el => el.tutorsId === category.id);
            ...
            return (
              category.img_src !== "https://realibi.kz/file/338803.png" && findedTutor !== undefined
                ? (
                  ...
                  console.log("findTutorId", findedTutor)}} key={idx} className={styles.category}>
                    ...
                    <label style={{display: "flex", flexDirection: "row", justifyContent: "center"}}>
                      <svg width="31" height="25" viewBox="0 0 41 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      {findedTutor?.courseCategory}
                      </p>
                    </label>
                    <label style={{display: "flex", flexDirection: "row", justifyContent: "center", flexShrink: 0}} > <svg width="19" height="25" viewBox="0 0 19 25" fill="none" xmlns="http://www.w3.org/2000/svg">
