  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          backgroundImage: `url(${props.coverImage?props.coverImage:props.course.img_src?props.course.img_src:"https://realibi.kz/file/338803.png"})`
        }}
      >
      </div>
      <div className={styles.fullname_container}>
        <p className={styles.fullname}>
          {props.course.tutor_fullname}
        </p>
      </div>
      <div className={styles.info_block}>
        <p className={styles.course_title}>Репетитор</p>
        <p className={styles.course_category}>
          {props.course.title?props.course.title:props.course.category_name}
        </p>
