...
export default function Header(props) {
    ...
    return (
        <div id={'header'} className={props.white != undefined ? styles.whiteHeader : styles.header}>
            ...
            <div className={styles.desktopHeader}>
                    ...
                    <ul className={styles.menu_ul}>
                        <li>
                            <a
                                ...
                                style={{color: props.white !== undefined ? 'black' : 'white'}}
                                onClick={() => {
                                    router.push('/about');
                                }}
                            >
                ...
                <div onClick={() => { setShowMobileMenu(!showMobileMenu) }} className={styles.menuButtonBody}>
                    <img src={props.white != undefined ? '/menu-button-of-three-horizontal-lines.png' : "/header-menu.png"} alt="menu" style={{width: '24px'}}/>
                    <span style={{
                        fontFamily: 'Rubik Medium',
                        fontSize: '18px',
                        marginLeft: '10px',
                        color: props.white != undefined ? 'black' : 'white'
                    }}>Меню</span>
                </div>
                ...
                (
                    <div className={styles.mobileMenu}>
                        <ul className={styles.menu_ul}>
                            ...
                            <li onClick={handleShow}>
                                <a className={styles.link} style={{color: props.white != undefined ? 'black' : 'white'}}>Стать партнёром</a>
                            </li>
                            {
                                isLogged ?
                                    (<li style={{color: props.white != undefined ? 'black' : 'white'}}>
                                        <Link href={cabinetRoute}>
                                            <a style={{color: props.white != undefined ? 'black' : 'white'}}>Личный кабинет</a>
                                        </Link>
                                        <span className={styles.exitBtn} onClick={()=>{
                                            setExitingOut(true)
                                    ...
                                    (<li>
                                        <Link href={cabinetRoute} className={styles.link}>
                                            <a style={{color: props.white != undefined ? 'black' : 'white'}}>Войти</a>
                                        </Link>
                                    </li>)
                            }
                        </ul>
