    ...
    <div className={styles.container}>
      ...
      <div className={styles.logo}>
        <Link href="/">
          ...
          >
            <svg width="158" viewBox="0 0 188 60" fill="none" xmlns="http://www.w3.org/2000/svg">
